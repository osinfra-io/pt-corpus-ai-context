# Platform Team: Corpus AI Context

Corpus team-level Copilot instructions for the [osinfra-io](https://github.com/osinfra-io) platform teams workspace.
...
`.github/instructions/team.instructions.md` — loaded via `COPILOT_CUSTOM_INSTRUCTIONS_DIRS`. Contains conventions shared across all corpus repositories:
...
- Regional workspace structure (root, `regional/`, and regional subdirectories)
- `shared/` symlinks pattern
